...
layout: post
post-image: "https://img.youtube.com/vi/VSYExV7Uz-k/sd1.jpg"
description: 这个GDC演讲主要讲了构建一个跨项目通用的UI框架所使用的原理。这些原理指导开发者在开发UI时，如何重复利用Unity的动画资源，如何使用模板资产快速生成常见的UI效果，如何让框架易于使用甚至设计师也能迅速上手等。该演讲对于设计一个简单易用、通用性强、节省迭代时间的UI框架有较高参考价值。原视频链接：https://youtu.be/VSYExV7Uz-k
tags:
- UI框架
- UI Framework
- 跨项目
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/01.png)

在接下来的 30 分钟里，我将讨论为什么构建一个 ui 框架可以对拥有多个团队或项目的公司有益、如何实现这个目标，并概述 ui 框架的主要组件和益处。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/02.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/03.png)

当我大约三年前加入公司时，我们只有 40 名员工，充满了发展的雄心壮志。现在我们有 100 多个员工。我们有多个独立的团队在从事不同的项目，但是在这种密集的增长过程中，重组 ui 开发过程并使其更有效是非常重要的。

那么为什么要构建一个ui框架呢？

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/04.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/05.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/06.png)

第一个原因是设计人员对 UI 设计如何实现没有足够的控制权。 这是我们在使用 ui 框架之前的工作流程的简化版本。 如您所见，实现部分由于太复杂，完全交给了工程师。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/07.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/08.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/09.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/10.png)

所以为了在执行阶段统一我们的 ui，我们开始构建自己的 ui 框架。

所以，如何实现？

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/11.png)

我们的第一步是确定好一些原则，确定好我们想在不同项目中复用的组件，

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/12.png)

我们最初的想法是基于原子设计方法，将 ui 视为一组元素和行为模式。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/13.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/14.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/15.png)

此时我们必须重建我们已经存在于 unity ui 中的大部分基本组件。因为即使UI框架扩展了Unity UI，也会有些组件不会刚刚好适合我们使用，我们必须重构他们。这其中的主要原因是它们不适用于移动设备，以及某些复杂的情况。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/16.png)

Unity 的 ui 需要编程知识才能掌握进阶的用法。 为了说明，我将向您展示一个最简单的 ui 框架组件之一：按钮。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/17.png)

它改进了结构以便提供反馈，并且还具有模块化的层次结构。

这个按钮和普通按钮最大的区别之一是，框架所用的按钮都有一个hitbox子对象，它本质上是一个不可见的图像，定义了按钮的交互区域。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/18.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/19.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/20.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/21.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/22.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/23.png)
  
这实际上真的是 ui 框架的最主要好处之一，因为现在设计师可以实现 ui 而无需编程。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/24.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/25.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/26.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/27.png)

让我们仔细看看每一个对象。

先说说相机。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/28.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/29.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/30.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/31.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/32.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/33.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/34.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/35.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/36.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/37.png)

这里可以看到背景在渐变褪色，就像弹出窗口正在缩放一样。此时我要做的是将它更改为我之前创建的 SlideRight（向右滑动）的 Transition Config，如您所见，隐藏和显示的更改将立即应用。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/38.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/39.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/40.png)

导航要求在视图之间执行。视图可以引用一个或多个 Slice。Slice 负责存放图形和逻辑。在特定情况下例如 Slice Panel 和动画目标，Slice 可以被包含在一个或多个视图中，它们可以被共享。

现在导航跳转可以由设计师构建。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/41.png)

一旦它们被构建完成，它们可以很容易地在视图中复用，或者被跨项目复用。并且很方便在项目中开展原型制作，节省时间。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/42.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/43.png)

一旦发现了一个好的解决方案并应用在 ui 框架中，所有项目都可以从中受益。当然，内部开发使我们能够非常快速地适应所有技术需求，无需等待，这真的很棒。

但是，当然要记住，构建 ui 框架不是灵丹妙药，我们仍然使用其他工具作为补充。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/44.png)

举个例子，我们仍然使用例如 TMP 样式表（style sheets）来进行连贯的排版。

> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/45.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/46.png)
...
> ![PPT](https://raw.githubusercontent.com/github00eric/github00eric.github.io/Release/assets/images/postImages/2022-09-01-GDC/47.png)